...
if (y_direction > 10 or y_direction < -10){
	phy_speed_y = choose(10,15,20,25)
}
...
constant_pressure_left = random_range(-20,-15)
constant_pressure_right = random_range(15,20)
...
spr_width = sprite_get_width(spr_asteroid_1);
spr_height = sprite_get_height(spr_asteroid_1);
x_mass_adj = random_range(-50,50);
y_mass_adj = random_range(-50,50);
